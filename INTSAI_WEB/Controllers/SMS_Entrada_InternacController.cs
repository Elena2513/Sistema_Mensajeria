...
{
    public class SMS_Entrada_InternacController : Controller
    {
        //[ValidarSesion]
        // GET: SMS_Entrada_Internac
        public ActionResult EntradaInternacional()
        {
            return View();
        }
        ...
        [HttpGet]
        public JsonResult FiltroMensajeria(string ReferenciaOCN, string nombrepersona, string tipodifusion, string motivodifusion, int TipoBusqueda, DateTime? FechaInicio, DateTime? FechaFinal)
        {
            var json = Json(MensajeriaC.List_Msj_EntradaInternacional(ReferenciaOCN, nombrepersona, tipodifusion, motivodifusion, TipoBusqueda, FechaInicio, FechaFinal), JsonRequestBehavior.AllowGet);
            return json;
        }
        ...
        //        control.NombreArchivo = archivoAdjunto.FileName;
        //    }
