...
var AgregarPersSN = {
    ...
    Add_PersonaSN: function () {

        var involucrado = {
            NombrePersona: $("#SN_nombrePers").val(),
        ...
        if (Personas.find(i => i.NombrePersona === involucrado.NombrePersona)) {
            ...
            sessionStorage.setItem("SN_ListaPersonas", JSON.stringify(Personas));
            html = "";
            ...
            $("#Table-personasSN").html(html);
            this.contarPersonas();
            //$("#modal_AddPersona").modal("hide");

            Snacional.CargarPersonas();
        }
    },
    ...
    Remover_Integrante: function (index) {
        ...
        $("#Tabla-DelitoSN").html(htmlDelitos);
        ...
        $("#Table-personasSN").html(htmlPersonas);
        this.contarPersonas();
...
$(function () {
    ...
    $("#Table-personasSN").on("click", "tr td .btn-remove-integrante", function () {
        index = parseInt($(this).attr("data-index"));
        AgregarPersSN.Remover_Integrante(index);
    });

    //Agregar Persona por el evento click
    $(".btn-AddPersonasSN").click(function () {
        AgregarPersSN.Add_PersonaSN();
        AgregarPersSN.Limpiar();
    });
